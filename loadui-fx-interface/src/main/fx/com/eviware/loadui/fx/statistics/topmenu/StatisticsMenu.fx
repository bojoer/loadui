				...
				content: [
					menuButton = MenuButton {
						...
						action: function():Void {
							println( "Using {StatisticsWindow.getInstance().wc} to set AOT..." );
							StatisticsWindow.getInstance().wc.setAlwaysOnTop( true ); /*openURL("http://www.loadui.org/Getting-results/the-statistics-window.html")*/ }
					}, MenubarButton {
