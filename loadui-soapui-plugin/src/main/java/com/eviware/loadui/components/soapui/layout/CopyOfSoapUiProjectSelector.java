...
public class CopyOfSoapUiProjectSelector
{
	public static final String TEST_CASE = "testCase";

	private static final Logger log = LoggerFactory.getLogger( CopyOfSoapUiProjectSelector.class );
	...
	public static CopyOfSoapUiProjectSelector newInstance( SoapUISamplerComponent component, ComponentContext context,
			SoapUITestCaseRunner testCaseRunner )
	{
		CopyOfSoapUiProjectSelector selector = new CopyOfSoapUiProjectSelector( context );
		context.addEventListener( PropertyEvent.class, selector.new PropertyChangedListener( component, testCaseRunner ) );
		return selector;
	}

	private CopyOfSoapUiProjectSelector( ComponentContext context )
	{
