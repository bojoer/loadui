...
public class GroovyAnalysis extends AnalysisBase
{
	...
	public GroovyAnalysis( GroovyBehaviorProvider scriptUpdateFirer, ComponentContext context )
	{
		super( context );
	...
	{
		scriptSupport.getEnvironment().invokeClosure( false, false, "analyze", message );
	}
