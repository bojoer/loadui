...
public class MenubarToggleButton extends ToggleButton {
	...
	override var graphic = Group {
		content: [
			SVGPath { layoutX: 2, layoutY: 2, content: bind shape, fill: bind if( armed or selected ) shadowArmedColor else shadowUnarmedColor },
			SVGPath { layoutX: 1, layoutY: 1, content: bind shape, fill: bind if( armed or selected ) armedColor else unarmedColor },
		]
	}
